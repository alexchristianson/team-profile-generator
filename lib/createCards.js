...
const createCards = (managerObj, engineerObj, internObj) => {
    ...
    <div class="card ml-3">
        <div class="card-header">
            ...
            <h3 class="card-title"><i class="fa-solid fa-mug-hot mr-3"></i>${manager.getRole()}</h3>
        </div>
        <div class="card-body">
            <ul class="list-group">
    ...
    <div class="card ml-3">
        <div class="card-header">
            ...
            <h3 class="card-title"><i class="fa-solid fa-glasses mr-3"></i>${engineer.getRole()}</h3>
        </div>
        <div class="card-body">
            <ul class="list-group">
    ...
    <div class="card ml-3">
        <div class="card-header">
            ...
            <h3 class="card-title"><i class="fa-solid fa-user-graduate mr-3"></i>${intern.getRole()}</h3>
        </div>
        <div class="card-body">
            <ul class="list-group">

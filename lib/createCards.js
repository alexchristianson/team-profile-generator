...
const createCards = (managerObj, engineerObj, internObj) => {
    ...
    const cardManager = managerObj.map(manager => {
        return `
        <div class="card col-sm-5 shadow p-3 m-3 bg-body rounded">
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a href="mailto:${manager.email}" target="blank">Email: ${manager.email}</a></li>
        ...
        <div class="card col-sm-5 shadow p-3 m-3 bg-body rounded">
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a href="mailto:${engineer.email}" target="blank">Email: ${engineer.email}</a></li>
